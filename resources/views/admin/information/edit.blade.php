...
<!-- Modal Tambah Informasi -->
    ...
    <div class="mb-4">
        <a href="{{ route('admin.information.index') }}" class="inline-flex items-center bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded-lg transition duration-150">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-full">
        ...
        <form action="{{ route('admin.information.update', $information->id) }}" method="POST"
            ...
            <div>
                <label for="photo" class="block text-sm font-medium text-gray-700 mb-1">Foto Cover Baru (Opsional)</label>
            ...
            <div class="flex space-x-3 pt-4 border-t border-gray-200">
                <button type="submit" class="bg-blue-600 text-white font-medium rounded-lg text-sm px-5 py-2.5 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 transition duration-150 ease-in-out">
                    Update
                </button>
                <a href="{{ route('admin.information.index') }}" class="bg-gray-500 text-white font-medium rounded-lg text-sm px-5 py-2.5 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-300 transition duration-150 ease-in-out">
                    Batal
                </a>
            </div>
        </form>
