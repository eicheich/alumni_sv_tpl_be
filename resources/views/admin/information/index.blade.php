            ...
            <div class="md:w-2/3 w-full">
                <div class="bg-white p-6 rounded-xl shadow-sm border">
                    <div class="flex justify-between items-center pb-4 border-b">
                        ...
                        <button type="button"
                            class="bg-blue-600 text-white p-1 rounded-md text-sm hover:bg-blue-700 transition duration-150 ease-in-out"
                            id="openAddInformationModalBtn" title="Tambah Informasi">
                        ...
                        <form method="GET" action="{{ route('admin.information.index') }}" class="mb-4 space-y-3">
                            <div class="flex flex-wrap gap-2">
                                ...
                                <select name="category_id"
                                    class="border border-gray-300 p-2 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <button type="submit"
                                    class="bg-blue-600 text-white p-2 text-sm rounded-md hover:bg-blue-700 transition duration-150 ease-in-out flex items-center gap-1">
                                    <i data-feather="search" class="w-4 h-4"></i> Filter
                                </button>
                                <a href="{{ route('admin.information.index') }}"
                                    class="bg-gray-500 text-white p-2 text-sm rounded-md hover:bg-gray-600 transition duration-150 ease-in-out flex items-center gap-1">
                                    ...
                                    <div class="bg-white rounded-2xl shadow-md overflow-hidden transition hover:shadow-lg">
                                        ...
                                        <div class="p-4">
                                            <p class="text-sm text-purple-600 font-medium mb-1">
                                                {{ $info->category->name ?? 'N/A' }}
                                            </p>
                                            <p class="text-xs font-semibold mb-2">
                                                Status:
                                                @if ($info->is_archive)
                                                    <span class="text-red-600">Diarsipkan</span>
                                                @else
                                            ...
                                            <div class="flex gap-2">
                                                ...
                                                <button type="button" onclick="openDeleteModal({{ $info->id }})"
            ...
            <div class="relative bg-white rounded-lg shadow-xl">
                ...
                <div class="p-4 md:p-5">
                    <form action="{{ route('admin.information.category.store') }}" method="POST" class="space-y-4">
                        @csrf
                        <div>
                            <label for="add_category_name" class="block text-sm font-medium text-gray-700 mb-1">Nama
                                Kategori</label>
                            <input type="text"
                        ...
                        <div>
                            <label for="add_category_visibility"
                                class="block text-sm font-medium text-gray-700 mb-1">Visibilitas</label>
                            <select id="add_category_visibility" name="visibility"
                                class="block w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 focus:ring-blue-500 focus:border-blue-500"
                                required>
                                <option value="1">Hanya Alumni</option>
                                <option value="0">Alumni &amp; Tamu</option>
                            </select>
                        </div>
                        <button type="submit"
            ...
            <div class="relative bg-white rounded-lg shadow-xl">
                ...
                <div class="p-4 md:p-5">
                    <form id="edit-category-form" action="" method="POST" class="space-y-4">
                        ...
                        @method('PUT')
                        <div>
                            <label for="edit_category_name" class="block text-sm font-medium text-gray-700 mb-1">Nama
                                Kategori</label>
                            <input type="text"
                                class="block w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div>
                            <label for="edit_category_visibility"
                                class="block text-sm font-medium text-gray-700 mb-1">Visibilitas</label>
                            <select id="edit_category_visibility" name="visibility"
                                class="block w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 focus:ring-blue-500 focus:border-blue-500"
                                required>
                                <option value="1">Hanya Alumni</option>
                                <option value="0">Alumni &amp; Tamu</option>
                ...
                <div class="p-4 md:p-5">
                    <form action="{{ route('admin.information.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <input type="text"
                                class="w-full px-4 py-2 bg-gray-100 rounded-lg text-sm focus:ring-2 focus:ring-purple-500 focus:outline-none @error('title') border-red-500 @else border-gray-300 @enderror"
                                id="title" name="title" placeholder="Masukkan judul informasi"
                        ...
                        <div>
                            <label for="information_category_id"
                                class="block text-sm font-medium text-gray-700 mb-1">Kategori</label>
                            <select
                                class="w-full px-4 py-2 bg-gray-100 rounded-lg text-sm focus:ring-2 focus:ring-purple-500 focus:outline-none @error('information_category_id') border-red-500 @else border-gray-300 @enderror"
                        ...
                        <div>
                            ...
                            <textarea
                                class="w-full px-4 py-2 bg-gray-100 rounded-lg text-sm focus:ring-2 focus:ring-purple-500 focus:outline-none @error('content') border-red-500 @else border-gray-300 @enderror"
                                id="content" name="content" rows="5" placeholder="Masukkan konten informasi" required>{{ old('content') }}</textarea>
                            @error('content')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="py-3">
                            <label for="is_archive" class="block text-sm font-medium text-gray-700 mb-1">Arsipkan
                                Informasi</label>
                            <input type="checkbox" id="is_archive" name="is_archive" value="1"
                                class="form-checkbox h-5 w-5 text-purple-600" {{ old('is_archive') ? 'checked' : '' }}>
                        </div>
