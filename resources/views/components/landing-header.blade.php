...
<nav class="bg-white shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div class="flex justify-between h-16">
            ...
            <!-- Desktop Menu -->
            <div class="hidden md:flex md:items-center md:space-x-6 text-sm font-medium">
                <a href="{{route('index')}}" 
                   class="{{ request()->routeIs('index') ? 'text-purple-600 font-semibold' : 'hover:text-purple-600' }}">
                   Beranda
                </a>

                <a href="{{route('information.index')}}" 
                   class="{{ request()->routeIs('information.index') ? 'text-purple-600 font-semibold' : 'hover:text-purple-600' }}">
                   Informasi Umum
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-2">
                <a href="{{route('alumni.login.view')}}">
                    <button class="bg-purple-600 text-white px-4 py-2 rounded-md text-sm hover:bg-purple-700">
                        Masuk
                    </button>
                </a>
                <a href="{{route('alumni.validate-data.view')}}">
                    <button class="bg-purple-400 text-white px-4 py-2 rounded-md text-sm hover:bg-purple-500">
                        Daftar
                    </button>
                </a>
            </div>
