        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"id="viewAlumniModalLabel">Detail Alumni</h5><button
                        type="button"class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div id="alumniDetailContent">
                        ...
                        button.addEventListener('click', function() {
                            ...
                            `).then(response => {
                                ...
                                ` : '/images/default-avatar.png';
                                    ...
                                    alumni.educational_backgrounds?.[0]?.graduation_year || 'N/A'
                                }
                                    ...
                                    alumni.career?.position || 'N/A'
                                        ...
                                        detailContent.innerHTML =
                                            ` <div class="alert alert-danger"> Gagal memuat detail alumni. Silakan coba lagi. </div> `;
                                    }
