...
style="width: 40px; height: 40px;"><i data-feather="user"style="width: 20px; height: 20px; color: #95a3b3;"></i></div>@endif <div class="user-header-text"><div class="user-header-name"> {
        {
        auth()->user()->name
    }
}
