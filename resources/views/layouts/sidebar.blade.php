...
<aside class="w-64 h-screen bg-white border-r hidden md:flex flex-col sticky top-0">
    ...
    <div class="border-t bg-white">
        <a href="{{ route('index') }}" class="block flex items-center py-3 px-6 hover:bg-gray-100">
            <i data-feather="globe" class="mr-2"></i>
            Lihat Situs
        </a>

        <a href="#" onclick="event.preventDefault();" class="block flex items-center py-3 px-6 hover:bg-gray-100">
